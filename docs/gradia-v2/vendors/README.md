...
| `customer-integrations/` | **Optional customer integrations** — never foundational; Gradia fully operational without them | Jobber (optional) · ~~Housecall Pro~~ (removed 2026-09-01, D-052 → `removed/`) |
...
| Customer integration | `CRMConnector` | Jobber / future provider (Housecall Pro removed, D-052) |
...
- **Housecall Pro** — **removed 2026-09-01 (CLEANUP-001, D-052)**: code, routes, tile, env vars and tests deleted; dormant columns only; removal record in `removed/housecall-pro.md`. Q-19 resolved as "delete".
