...
- **P0-005 → P0-006 and P0-007**: the dedupe foundation (unique indexes / provider_events strategy, `usage_events` vendor_ref uniqueness) lands once; the two provider tickets build on it rather than inventing per-route mechanisms.
...
8. **Reliable event processing precedes autonomy expansion (added 2026-07-27, roadmap rule 9):** E09 requires P0-005/006/007 + P0-012 complete; the E10 outbox is not the bar, but E09 tickets on webhook/cron paths state their idempotency basis.
