...
| 9 | Calendar and availability | P0 / P2 | building / designed | P0-003 service (PR #10) + **P0-004 enforcement merged 2026-08-11** (PR #12 — every booking/reschedule/voice/drag/block-time path checks; D-015 hard-block, D-016 recorded override; internal failures fail closed). **Dormant behind `NEXT_PUBLIC_GRADIA_CONFLICT_ENFORCEMENT` (OFF in production; Cursor enablement verdict NOT READY)** — advances to *internal* on the flag flip after P0-004A hardening (issue #13) + founder manual acceptance. E02 native source of truth (D-013) still designed |
