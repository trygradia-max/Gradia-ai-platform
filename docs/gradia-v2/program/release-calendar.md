...
|---|---|
| Alpha hardening release(s) | Individual P0-ticket batches may ship to prod as they pass review — flags off where risky. Shipped so far: P0-001 (PR #8, 2026-07-30) · P0-002 (PR #9, 2026-07-30) · P0-003 (PR #10, 2026-08-06) · P0-004 (PR #12, 2026-08-11 — conflict enforcement wired on every path, dormant behind `NEXT_PUBLIC_GRADIA_CONFLICT_ENFORCEMENT`) · **P0-004A (PR #15, 2026-08-11 — booking atomicity/concurrency: per-shop serialized writes + durable idempotency live immediately regardless of the flag; conflict enforcement still dormant; see `../releases/README.md`)**. The production flag flip remains the release event, now gated only on founder manual acceptance (P0-004A hardening gate satisfied). |
