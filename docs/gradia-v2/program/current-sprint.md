...
- **P0-006** (Twilio inbound replay protection) — now the **next implementation position**, but **blocked** until the P0-005A filing + P0-005 planning closeout land on `main` (both delivered in the `docs/close-p0-005` commit — entry in `blocked.md`; the Organizer flips it to ready on merge). ADR-001 C3 binds its scope: claim strictly after signature verification, test-locked. Not started.

## WIP limits (restated, binding)

| Limit | Rule | Current state |
|---|---|---|
| Active implementation tickets | max **2** | 1 active (P0-001 in-review); P0-002/P0-003/P0-004/P0-004A/P0-005 done (latest: P0-005, 2026-08-13, PR #17) — one slot free, reserved next for P0-006 (blocked pending closeout merge) ✓ |
| Database-sensitive tickets active | max **1** | **0** — P0-005 shipped its two migrations (`20260812120000`/`20260812130000` + unapplied rollback) and closed 2026-08-13; slot free (P0-006 is not DB-sensitive) ✓ |
| Payment / tenancy / calendar high-risk tickets active | max **1** | 0 — free since the P0-004A close (2026-08-11); P0-005/P0-006 do not occupy it ✓ |
