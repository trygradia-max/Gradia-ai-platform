...
- **Blocks:** marketing-site pricing page; trial-allowance numbers (Q-13); Stripe Billing product setup; `15-cost-and-margin-model.md` re-derivation; Q-18 framing ("the $20 promise" language is now stale).
