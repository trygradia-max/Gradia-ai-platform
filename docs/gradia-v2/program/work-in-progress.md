...
| Active 2 | P0-002 — CI typecheck, lint, build and integration enforcement | Standard | _open — assign one Builder session_ | _open — assign one Cursor Reviewer_ | ready (slotted — in-progress when a Builder is recorded here) |
| Database-sensitive | — empty — | — | — | — | Slot free until P0-005 (the first genuinely DB-sensitive P0 ticket) |
| High-risk (payments/tenancy/calendar) | — empty — | — | — | — | P0-003 takes this slot in Sprint 2, only after P0-002 completes |

Slot accounting: 2/2 active · **0/1 database-sensitive** · 0/1 high-risk. **No further ticket may start (active slots full).**
