...
| C-12 | `agents.ts` receptionist catalog copy describes the retired Slack approval flow; `data/customers.ts` docstring claims IG/FB search | Code-comment/copy drift, not doc conflict; fix rides in P0-010. |
