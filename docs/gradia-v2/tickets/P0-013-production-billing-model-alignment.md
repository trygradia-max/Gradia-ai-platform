...
- UI hardcodes prices as strings: `src/app/billing/page.tsx` ("From $20/month", "$49/mo"), `billing-subscribe.tsx` ("Subscribe — $49|$20/month", "+$29/month"), `usage-meters.tsx` ("Add 950 credits — $10", "Add 40 minutes — $10"), `onboarding-launch-steps.tsx`, `voice-builder.ts` error strings, `how-it-works/page.tsx` ("$20/month. No catch."). None derive from `PLAN`; none are test-locked.
  - _UX-001 check (2026-09-02): the owner-visible list above is complete for `$20/$29/$49/$10` strings; the `voice-builder.ts` entry is `src/app/actions/voice-builder.ts`; the remaining `$` literals (`pricing.ts`, `entitlements.ts`, `stripe.ts`, `actions/billing.ts`, `margin-report.ts`, `api/stripe/webhook`) are the pricing sources already in the module list. UX-001 touched none of them._
