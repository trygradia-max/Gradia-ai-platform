...
| P0-011 | Service-role tenant-scoping review and helper design | E00 | **ready — next implementation position** (promoted 2026-08-28 at the P0-010 close; enters in-progress when the Organizer slots it and a Builder is recorded on the WIP board; proceeds independently of P0-013) | High | P0-002 (done) | tenancy | `P0-011-service-role-tenant-scoping-review.md` |
