...
| P0-005 | Webhook event idempotency foundation | E00 | **ready — next up** (moved into the next active implementation position 2026-08-11 at P0-004A close; occupies the DB-sensitive slot when it starts) | High | P0-002 (done) · P0-004A (done) | database-sensitive | `P0-005-webhook-idempotency-foundation.md` |
