...
| P0-010 | Production environment and error-surface cleanup | E00 | **blocked — next implementation position** (moved up 2026-08-26 at the P0-009 close; unblocks when the `docs/close-p0-009` closeout lands on `main`) | Medium | P0-002 (done) · closeout merge (pending) | none | `P0-010-production-env-error-surface-cleanup.md` |
