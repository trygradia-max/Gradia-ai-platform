...
| P0-004 | Conflict enforcement across booking and scheduling paths | E00 | **done** (2026-08-11, PR #12 `3b6d044`; CI green; review rounds `d43ce16`/`c0b66b1` addressed; enforcement dormant behind `NEXT_PUBLIC_GRADIA_CONFLICT_ENFORCEMENT` — production flag flip gated on founder manual acceptance; merge/review record in the ticket file) | High | P0-003 (done) | calendar | `P0-004-conflict-enforcement-booking-paths.md` |
| P0-005 | Webhook event idempotency foundation | E00 | **ready — next up** (P0-004 done 2026-08-11; occupies the DB-sensitive slot when the Organizer slots it — not started) | High | P0-002 (done) | database-sensitive | `P0-005-webhook-idempotency-foundation.md` |
