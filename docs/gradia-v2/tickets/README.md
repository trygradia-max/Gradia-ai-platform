...
| P0-006 | Twilio inbound replay protection | E00 | **blocked — next implementation position** (moved up 2026-08-13 at P0-005 close; blocked until (1) the P0-005A retention follow-up is filed and (2) the P0-005 planning closeout is complete — both delivered in the `docs/close-p0-005` closeout commit; the Organizer flips this to ready once that commit lands on `main`. ADR-001 C3 binds its scope: claim only AFTER signature verification, test-locked. Entry in `../program/blocked.md`) | High | P0-005 (done) · P0-005A filed · closeout merge | none | `P0-006-twilio-inbound-replay-protection.md` |
