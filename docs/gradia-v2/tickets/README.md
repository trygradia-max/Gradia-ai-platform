...
| P0-004A | Appointment booking atomicity and concurrency | E00 | **ready — next up** (promoted 2026-08-11 ahead of P0-005; scope in GitHub issue #13 + the P0-004 merge record — executor atomicity, partial state, TOCTOU/concurrency, locking/transaction strategy; ticket spec to be cut from the issue) | High | P0-004 (done) | calendar | GitHub issue #13 (no ticket file yet) |
| P0-005 | Webhook event idempotency foundation | E00 | **queued behind P0-004A** (2026-08-11 resequencing; occupies the DB-sensitive slot when it starts) | High | P0-002 (done) · P0-004A ordering | database-sensitive | `P0-005-webhook-idempotency-foundation.md` |
